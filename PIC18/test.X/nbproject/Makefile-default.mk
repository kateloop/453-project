...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/iodemo.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/iodemo.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/iodemo.p1
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1472/iodemo.p1: ../iodemo.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	${MP_CC} --pass1 ../iodemo.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR}/_ext/1472 -N31 --warn=0 --runtime=default,+clear,+init,-keep,-download,+stackwarn,-config,+clib,-plib --opt=default,+asm,-asmfile,-speed,+space,9 -D__DEBUG --debugger=realice --cp=16 -Blarge --double=24  --mode=lite -g --asmlist "--errformat=%%f:%%l: error: %%s" "--msgformat=%%f:%%l: advisory: %%s" "--warnformat=%%f:%%l warning: %%s"  
	@${MP_CC} --scandep  ../iodemo.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR}/_ext/1472 -N31 --warn=0 --runtime=default,+clear,+init,-keep,-download,+stackwarn,-config,+clib,-plib --opt=default,+asm,-asmfile,-speed,+space,9 -D__DEBUG --debugger=realice --cp=16 -Blarge --double=24  --mode=lite -g --asmlist "--errformat=%%f:%%l: error: %%s" "--msgformat=%%f:%%l: advisory: %%s" "--warnformat=%%f:%%l warning: %%s"  
	@echo ${OBJECTDIR}/_ext/1472/iodemo.p1: > ${OBJECTDIR}/_ext/1472/iodemo.p1.d
	@cat ${OBJECTDIR}/_ext/1472/iodemo.dep >> ${OBJECTDIR}/_ext/1472/iodemo.p1.d
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/iodemo.p1.d" $(SILENT) -ht
