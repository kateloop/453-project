...
#define SRCCR_VAL 0x00007000	// TODO check value - do we even need to set?
#define SCR_VAL   0x00000013	// TODO check value - do we even need to set?
...
void main (int argc, char** argv) {
	...
	SCR |= SSIEN_ORMASK;
	// Set all other control bits (ie TXDIR, RXDIR, etc)
	// TODO
