# 
# Project automation script for Audio 
# 
# Created for ISE version 12.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Audio.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "CLOCK_GEN.v"
   xfile add "ac97.v"
   xfile add "ece453_TLL5000_spring2012.ucf"
   xfile add "ece453_master_module.v"
   xfile add "ece453_top_level.v"
   xfile add "main.v"
   xfile add "processing.v"

   # Set the Top Module as well...
   project set top "ece453_top_level"
